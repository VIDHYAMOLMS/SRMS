...
<body>
  ...
  <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Student Request Management System</a>
  ...
  <div class="container">
    ...
    <form method="POST" autocomplete="off">
      ...
      <label><b>Select Application Type :</b></label>
      <!-- error message if type of absence isn't selected -->
      <span class="error"><?php echo "&nbsp;".$absenceErr ?></span><br/>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="radio" value="leave" id="Sick" required>
      ...
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="radio" value="early exit" id="Vacation">
        <label class="form-check-label" for="early exit">
          Early Exit Application
        </label>
      </div>
      <div class="form-check">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" name="reason" id="leaveDesc" rows="10" placeholder="Enter Here..."></textarea>
      </div>
